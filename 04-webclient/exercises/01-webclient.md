...
In this exercise you will practice using Spring Boot's WebClient to make HTTP requests to a public API. You will implement several functions that utilize WebClient to fetch and process data.

## Introduction
Your task is to call three different APIs using WebClient and combine the results, into a single response.
- https://agify.io
- https://genderize.io
...
- Create a WebClient bean to be used for making HTTP requests.
- Implement a service that uses WebClient to call the three APIs and fetch data based on the provided name.
